...
function ProfileUpdate() {
  ...
  const fetchUserData = () => {
    ...
    axios.get(`https://quoteflix-register-login.onrender.com/user/${userEmail}`)
      .then(response => {
  ...
  const handleUpdate = async (event) => {
    ...
    try {
      ...
      const response = await axios.put(`https://quoteflix-register-login.onrender.com/user/${userEmail}`, updatedUserData);
