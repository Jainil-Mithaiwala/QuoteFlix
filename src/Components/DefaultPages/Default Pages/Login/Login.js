...
function Login() {
  ...
  function handleSubmit(event) {
    ...
    axios.post('https://quoteflix-register-login.onrender.com/login', { email, password })
      .then(res => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      <div className="wrapper">
        ...
        <h5 align="center" className='logintext'><a className='loginlink' href="/registration_page">Sign In</a></h5>
      </div>
    </form>
  );
}
