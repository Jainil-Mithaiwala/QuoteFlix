...
const RandomTipGenerator = () => {
  ...
  const fetchRandomQuote = async () => {
    try {
      ...
      setRandomTipInfo(response.data.AI_and_Machine_Learning_tip.info);
      setRandomTipHeading(response.data.AI_and_Machine_Learning_tip.heading);
    } catch (error) {
  ...
  return (
    <div className='homecontainer'>
      ...
      <div className='container2'>
        ...
        <div>
          <h1 className='Heading'>AI and Machine Learning Tip</h1>
          <div className='box'>
            {randomTipHeading ? (
              <div>
