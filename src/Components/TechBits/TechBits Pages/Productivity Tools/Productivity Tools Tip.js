...
const RandomTipGenerator = () => {
  ...
  const fetchRandomQuote = async () => {
    try {
      ...
      setRandomTipInfo(response.data.Productivity_Tools_tip.info);
      setRandomTipHeading(response.data.Productivity_Tools_tip.heading);
    } catch (error) {
  ...
  return (
    <div className='homecontainer'>
      ...
      <div className='container2'>
        ...
        <div>
          <h1 className='Heading'>Productivity Tools Tip</h1>
          <div className='box'>
            {randomTipHeading ? (
              <div>
