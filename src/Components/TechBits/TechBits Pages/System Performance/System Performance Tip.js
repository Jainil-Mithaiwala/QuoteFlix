...
const RandomTipGenerator = () => {
  ...
  const fetchRandomQuote = async () => {
    try {
      ...
      setRandomTipInfo(response.data.System_Performance_tip.info);
      setRandomTipHeading(response.data.System_Performance_tip.heading);
    } catch (error) {
  ...
  return (
    <div className='homecontainer'>
      ...
      <div className='container2'>
        ...
        <div>
          <h1 className='Heading'>System Performance Tip</h1>
          <div className='box'>
            {randomTipHeading ? (
              <div>
