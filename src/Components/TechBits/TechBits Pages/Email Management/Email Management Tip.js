...
const RandomTipGenerator = () => {
  ...
  const fetchRandomQuote = async () => {
    try {
      ...
      setRandomTipInfo(response.data.Email_Management_tip.info);
      setRandomTipHeading(response.data.Email_Management_tip.heading);
    } catch (error) {
  ...
  return (
    <div className='homecontainer'>
      ...
      <div className='container2'>
        ...
        <div>
          <h1 className='Heading'>Email Management Tip</h1>
          <div className='box'>
            {randomTipHeading ? (
              <div>
