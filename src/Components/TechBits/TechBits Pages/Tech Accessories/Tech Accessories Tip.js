...
const RandomTipGenerator = () => {
  ...
  const fetchRandomQuote = async () => {
    try {
      ...
      setRandomTipInfo(response.data.Tech_Accessories_tip.info);
      setRandomTipHeading(response.data.Tech_Accessories_tip.heading);
    } catch (error) {
  ...
  return (
    <div className='homecontainer'>
      ...
      <div className='container2'>
        ...
        <div>
          <h1 className='Heading'>Tech Accessories Tip</h1>
          <div className='box'>
            {randomTipHeading ? (
              <div>
