...
const RandomTipGenerator = () => {
  ...
  const fetchRandomQuote = async () => {
    try {
      ...
      setRandomTipInfo(response.data.Smartphone_Tips_tip.info);
      setRandomTipHeading(response.data.Smartphone_Tips_tip.heading);
    } catch (error) {
  ...
  return (
    <div className='homecontainer'>
      ...
      <div className='container2'>
        ...
        <div>
          <h1 className='Heading'>Smartphone Tip</h1>
          <div className='box'>
            {randomTipHeading ? (
              <div>
