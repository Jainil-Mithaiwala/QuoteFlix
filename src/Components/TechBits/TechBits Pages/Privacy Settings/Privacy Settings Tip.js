...
const RandomTipGenerator = () => {
  ...
  const fetchRandomQuote = async () => {
    try {
      ...
      setRandomTipInfo(response.data.Privacy_Settings_tip.info);
      setRandomTipHeading(response.data.Privacy_Settings_tip.heading);
    } catch (error) {
  ...
  return (
    <div className='homecontainer'>
      ...
      <div className='container2'>
        ...
        <div>
          <h1 className='Heading'>Privacy Settings Tip</h1>
          <div className='box'>
            {randomTipHeading ? (
              <div>
