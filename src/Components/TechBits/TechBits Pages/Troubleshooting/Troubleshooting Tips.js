...
const RandomTipGenerator = () => {
  ...
  const fetchRandomQuote = async () => {
    try {
      ...
      setRandomTipInfo(response.data.Troubleshooting_tip.info);
      setRandomTipHeading(response.data.Troubleshooting_tip.heading);
    } catch (error) {
  ...
  return (
    <div className='homecontainer'>
      ...
      <div className='container2'>
        ...
        <div>
          <h1 className='Heading'>Troubleshooting Tip</h1>
          <div className='box'>
            {randomTipHeading ? (
              <div>
