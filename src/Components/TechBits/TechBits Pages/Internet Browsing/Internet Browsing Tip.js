...
const RandomTipGenerator = () => {
  ...
  const fetchRandomQuote = async () => {
    try {
      ...
      setRandomTipInfo(response.data.Internet_Browsing_tip.info);
      setRandomTipHeading(response.data.Internet_Browsing_tip.heading);
    } catch (error) {
  ...
  return (
    <div className='homecontainer'>
      ...
      <div className='container2'>
        ...
        <div>
          <h1 className='Heading'>Internet Browsing Tip</h1>
          <div className='box'>
            {randomTipHeading ? (
              <div>
