...
const RandomTipGenerator = () => {
  ...
  const fetchRandomQuote = async () => {
    try {
      ...
      setRandomTipInfo(response.data.Home_Automation_tip.info);
      setRandomTipHeading(response.data.Home_Automation_tip.heading);
    } catch (error) {
  ...
  return (
    <div className='homecontainer'>
      ...
      <div className='container2'>
        ...
        <div>
          <h1 className='Heading'>Home Automation Tip</h1>
          <div className='box'>
            {randomTipHeading ? (
              <div>
