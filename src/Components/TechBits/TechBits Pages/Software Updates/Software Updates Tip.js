...
const RandomTipGenerator = () => {
  ...
  const fetchRandomQuote = async () => {
    try {
      ...
      setRandomTipInfo(response.data.Software_Updates_tip.info);
      setRandomTipHeading(response.data.Software_Updates_tip.heading);
    } catch (error) {
  ...
  return (
    <div className='homecontainer'>
      ...
      <div className='container2'>
        ...
        <div>
          <h1 className='Heading'>Software Updates Tip</h1>
          <div className='box'>
            {randomTipHeading ? (
              <div>
