...
const RandomTipGenerator = () => {
  ...
  const fetchRandomQuote = async () => {
    try {
      ...
      setRandomTipInfo(response.data.Online_Safety_tip.info);
      setRandomTipHeading(response.data.Online_Safety_tip.heading);
    } catch (error) {
  ...
  return (
    <div className='homecontainer'>
      ...
      <div className='container2'>
        ...
        <div>
          <h1 className='Heading'>Online Safety Tip</h1>
          <div className='box'>
            {randomTipHeading ? (
              <div>
