...
const RandomTipGenerator = () => {
  ...
  const fetchRandomQuote = async () => {
    try {
      ...
      setRandomTipInfo(response.data.Gadget_Optimization_tip.info);
      setRandomTipHeading(response.data.Gadget_Optimization_tip.heading);
    } catch (error) {
  ...
  return (
    <div className='homecontainer'>
      ...
      <div className='container2'>
        ...
        <div>
          <h1 className='Heading'>Gadget Optimization Tip</h1>
          <div className='box'>
            {randomTipHeading ? (
              <div>
