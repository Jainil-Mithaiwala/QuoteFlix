...
const RandomTipGenerator = () => {
  ...
  const fetchRandomQuote = async () => {
    try {
      ...
      setRandomTipInfo(response.data.Computer_Maintenance_tip.info);
      setRandomTipHeading(response.data.Computer_Maintenance_tip.heading);
    } catch (error) {
  ...
  return (
    <div className='homecontainer'>
      ...
      <div className='container2'>
        ...
        <div>
          <h1 className='Heading'>Computer Maintenance Tip</h1>
          <div className='box'>
            {randomTipHeading ? (
              <div>
