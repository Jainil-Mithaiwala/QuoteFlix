...
const RandomTipGenerator = () => {
  ...
  const fetchRandomQuote = async () => {
    try {
      ...
      setRandomTipInfo(response.data.Social_Media_tip.info);
      setRandomTipHeading(response.data.Social_Media_tip.heading);
    } catch (error) {
  ...
  return (
    <div className='homecontainer'>
      ...
      <div className='container2'>
        ...
        <div>
          <h1 className='Heading'>Social Media Tip</h1>
          <div className='box'>
            {randomTipHeading ? (
              <div>
